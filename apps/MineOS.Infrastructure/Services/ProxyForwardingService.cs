...
public class ProxyForwardingService : IProxyForwardingService
{
    ...
    {
        // SetUnixFileMode throws PlatformNotSupportedException off Unix, which the
        // catch below would swallow into a misleading warning. Guarding on the
        // platform matches OwnershipHelper and ProcessManager, and is what tells
        // the analyzer this call site is Unix-only (CA1416).
